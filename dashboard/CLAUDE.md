...
1. **README.md** — 기능 개요, 배경, 목표를 간단히 서술
2. **spec.md** — 요구사항 중심 (유저 스토리, 인수 시나리오, 기능 요구사항). 기술 내용 제외
3. **plan.md** — 기술 및 구현 계획 (아키텍처, 구현 단계, 검증 방법)
4. **tasks.md** — 구현 작업 체크리스트
5. **progress.md** — tasks와 맞추며 진행 상황을 지속적으로 기록
6. **findings.md** — 발견한 사실, 결정, 배운 점을 즉시 기록. 사실상 프로젝트 메모리
